...
from olympiad.decorators import login_required_or_session
from olympiad.views import db, orders_ref, serialize_firestore_document, itemsRef, get_cart, cart_ref, users_ref, \
...
def form_page(request):
    ...
    return render(request, 'oliverweber/shop_page.html', context)
