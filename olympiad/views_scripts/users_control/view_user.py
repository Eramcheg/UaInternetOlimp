...
from olympiad.views import addresses_ref, cart_ref, get_user_category, serialize_firestore_document, users_ref, is_admin
...
def view_user(request, user_id):
    ...
    for user in existing_user:
        ...
        from olympiad.views_scripts.profile_views import get_orders_for_user
