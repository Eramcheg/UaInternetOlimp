...
from olympiad.forms import UserRegisterForm, User, BannerForm
from django.utils.translation import gettext as _

from olympiad.models import Banner

json_file_path = os.path.join(settings.BASE_DIR, "olympiad", "static", "olimp_key.json")
GEOIP_path = os.path.join(settings.BASE_DIR, "olympiad", "static", "GEOIP", "GeoLite2-Country.mmdb")
